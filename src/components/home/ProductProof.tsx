...
const flipIcons = [Eye, Calculator, Phone];
      ...
      <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
        <AnimateOnScroll>
          <SectionHeader
            label={t.proof.label}
            title={t.proof.title}
            titleAccent={t.proof.titleAccent}
            punchline={t.proof.punchline}
          />
        </AnimateOnScroll>
            ...
            <div className="grid md:grid-cols-2">
              <div className="bg-[#111111] px-6 py-8 text-white md:px-10 md:py-12">
                ...
                <ul className="mt-8 space-y-4">
                  {t.proof.flips.map((item, i) => {
                    const Icon = flipIcons[i];
                    return (
